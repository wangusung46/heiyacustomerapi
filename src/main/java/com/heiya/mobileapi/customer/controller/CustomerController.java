 ...
 * This controller will handle all of customer inquiry and management
 *
 */
...
public class CustomerController {
	...
	public ResponseEntity<?> doLogout(@PathVariable String mobileNo, String idToken) throws JsonProcessingException {
	...
	public ResponseEntity<?> doInquiryMobile(Device device, @PathVariable("version") String version) throws JsonProcessingException {
            ...
            try {
                    ...
                    LOGGER.info("======== COMPLETED CustomerController.doInquiryMobileAndroid : platform " + device.getDevicePlatform().name() + " and version " + version);
                    return ResponseEntity.ok(response);
            }
            catch (Exception e) {
                    LOGGER.error(e.getMessage(), e);
